...
import com.asoiu.simbigraph.algorithms.subgraph.ParallelFourSizeSubgraphsCounterSampling.EdgeLayerParameters;
import com.asoiu.simbigraph.algorithms.subgraph.ParallelFourSizeSubgraphsCounterSampling.VertexLayerParameters;
...
public class FourSizeSubgraphsCounterSampling<V, E> {
	 ...
	 */
	public FourSizeSubgraphsCounterSampling(Hypergraph<V, E> graph, Map<Integer, VertexLayerParameters<V>> vertexLayers, Map<Integer, EdgeLayerParameters<E>> edgeLayers) {
