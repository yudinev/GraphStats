...
import com.asoiu.simbigraph.algorithms.subgraph.ParallelThreeSizeSubgraphsCounterSampling.VertexLayerParameters;
...
public class ThreeSizeSubgraphsCounterSampling<V, E> {
	 ...
	 */
	public ThreeSizeSubgraphsCounterSampling(Hypergraph<V, E> graph, Map<Integer, VertexLayerParameters<V>> vertexLayers) {
        this.graph = graph;
